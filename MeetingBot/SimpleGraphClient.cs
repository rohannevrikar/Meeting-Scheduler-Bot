...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class SimpleGraphClient
    {
        ...
        public async Task<List<string>> GetAttendeeEmailFromName(string attendee)
        {
            ...
            try
            {
                matchingEmails = users.Where(a => RemoveWhitespace(a.DisplayName).Contains(attendee, StringComparison.OrdinalIgnoreCase) || a.UserPrincipalName.Contains(attendee, StringComparison.OrdinalIgnoreCase)).Select(a => a.UserPrincipalName).ToList();
